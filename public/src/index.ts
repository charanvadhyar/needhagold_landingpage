...
async function setupViewer(){
    ...
    // WEBGi load modeljewlery-site-landing-page-main\public\assets\ring_webgi.glb
    await manager.addFromPath("assets/glb_files/ring_webgi.glb");
    ...
    function setupScrollAnimation(){
        ...
        .addLabel("Emotions")
        .to('.side-bar .forever', { opacity: 0.5, scale: 1, ease: "power4.inOut", duration: 3, scrollTrigger: { trigger: ".cam-view-3", start: "top bottom", end: 'top top', scrub: 1, immediateRender: false,}})
        .to('.side-bar .emotions', { opacity: 1, scale: 1.5, ease: "power4.inOut", duration: 3, scrollTrigger: { trigger: ".cam-view-3", start: "top bottom", end: 'top top', scrub: 1, immediateRender: false}})
        ...
        .addLabel("Contact")
        .to('.side-bar .emotions', { opacity: 0.5, scale: 1, ease: "power4.inOut", duration: 4, 
            scrollTrigger: { 
                trigger: ".cam-view-4", 
                start: "top bottom", 
                end: 'top top', 
        ...
        .to('.side-bar .contact', { opacity: 1, scale: 1.5, ease: "power4.inOut", duration: 4, 
            scrollTrigger: { 
                trigger: ".cam-view-4", 
                start: "top bottom", 
                end: 'top top', 
